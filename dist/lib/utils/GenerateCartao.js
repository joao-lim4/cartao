...
const Cards = cartoes_pt_br_1.default.DefautlCards;
class GenerateCartao {
    constructor(options) {
        ...
        this._optionsInstace = false;
        this._initialState = Object.assign({}, this._options);
        if (options) {
...
exports.default = GenerateCartao;
//# sourceMappingURL=GenerateCartao.js.map